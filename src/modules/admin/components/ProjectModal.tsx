  ...
  return (
    <Portal isOpen={isOpen}>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 bg-slate-900/60 backdrop-blur-md animate-fade-in">
        <div 
          className="bg-white rounded-[32px] w-full max-w-2xl max-h-[90vh] shadow-2xl overflow-hidden border border-slate-100 animate-scale-up flex flex-col"
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-slate-50/70 border border-slate-200 rounded-2xl p-5 text-slate-800 font-bold focus:bg-white focus:border-[#004C6C] focus:ring-4 focus:ring-blue-900/5 transition-all outline-none text-sm placeholder:text-slate-300 resize-none"
              />
            </div>

            {/* Estado Switch */}
            <div className="flex items-center justify-between p-4 bg-slate-50/70 border border-slate-200 rounded-2xl">
